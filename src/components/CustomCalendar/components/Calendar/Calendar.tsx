    ...
    <div className='calendar'>
      <div className='calendar__header'>
        ...
        {state.mode === 'days' && (
          ...
          >
            {translateMonthName(state.monthesNames[state.selectedMonth.monthIndex].month)}{' '}
            {state.selectedYear}
          </div>
        )}
        {state.mode === 'monthes' && (
            ...
            <div className='calendar__week__names'>
              {state.weekDaysNames.map((weekDaysName) => (
                <div key={weekDaysName.dayShort}>
                  {translateDayAbbreviation(weekDaysName.dayShort)}
                </div>
              ))}
            </div>
          ...
          <div className='calendar__pick__items__container'>
            {state.monthesNames.map((monthesName) => {
              ...
              return (
                ...
                >
                  {translateMonthAbbreviation(monthesName.monthShort)}
                </div>
              )
            })}
          </div>
