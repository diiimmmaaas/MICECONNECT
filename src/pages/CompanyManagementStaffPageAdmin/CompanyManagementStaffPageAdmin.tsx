...
import styles from './CompanyManagementStaffPageAdmin.module.css'
...
const CompanyManagementStaffPageAdmin = () => {
  ...
  const onActiveCurrentCompanyCard = (id: number) => {
    navigate(`${PATH.companyStaffCardPageAdmin}${companyId}/${id}`)
  }
...
export default CompanyManagementStaffPageAdmin
